...
// Returns the private 'App\Repository\CsvImportRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CsvImportRepository.php';

return $this->privates['App\Repository\CsvImportRepository'] = new \App\Repository\CsvImportRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
