...
// Returns the private 'App\Repository\PeopleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PeopleRepository.php';

return $this->privates['App\Repository\PeopleRepository'] = new \App\Repository\PeopleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
